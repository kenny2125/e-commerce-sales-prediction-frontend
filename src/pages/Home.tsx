        ...
        <div className="relative z-20 container mx-auto h-full flex flex-col justify-center px-4 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:ml-auto w-full max-w-md">
              <QuickCheckoutForm className="bg-white/95 backdrop-blur" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="relative p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">495-3333 | 253-9310 | 495-7878</p>
                    <p className="text-sm text-gray-600">254-8940 | 253-9250 | 253-9359 | 252-3049</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">skycos@yahoo.com | acctg.sky@gmail.com</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button size="lg" variant="ghost" className="border-white hover:bg-white/20" onClick={() => document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' })}>
              Contact Sales
            </Button>
          </div>
        </div>
